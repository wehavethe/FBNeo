...
static struct BurnRomInfo zerofxtsRomDesc[] = {
       { "p0500.v10",                  0x0400000, 0xe4a92b7b   , 1 | BRF_PRG | BRF_ESS }, //  0 68K Code

       { "t0500.rom",                  0x0400000, 0x593f07e3, 2 | BRF_GRA },                   //  1 Tile data
       { "t0501.rom",                  0x0200000, 0xd2106864, 2 | BRF_GRA },                   //  2

       { "a0500.rom",                  0x0400000, 0x80a59197, 3 | BRF_GRA },                   //  3 Sprite Color Data
       { "a0501.rom",                  0x0400000, 0xb946398d, 3 | BRF_GRA },                   //  4
       { "a0502.rom",                  0x0400000, 0xc3fcdf1d, 3 | BRF_GRA },                   //  5
       { "a0503.rom",                  0x0400000, 0x066dffec, 3 | BRF_GRA },                   //  6
       { "a0504.rom",                  0x0400000, 0x45337583, 3 | BRF_GRA },                   //  7
       { "a0505.rom",                  0x0400000, 0x5b8cf3a5, 3 | BRF_GRA },                   //  8
       { "a0506.rom",                  0x0400000, 0xf5e5cce3, 3 | BRF_GRA },                   //  9

       { "b0500.rom",                  0x0400000, 0x2b273a17, 4 | BRF_GRA },                   // 10 Sprite Masks & Color Indexes
       { "b0501.rom",                  0x0400000, 0x1546c2e9, 4 | BRF_GRA },                   // 11
       { "b0502.rom",                  0x0400000, 0xe97b31c3, 4 | BRF_GRA },                   // 12
       { "b0503.u16",                  0x0400000, 0x9679f77d, 4 | BRF_GRA },                   // 13

       { "m0500.rom",                  0x0200000, 0x37928cdd, 5 | BRF_SND },                   // 14 Samples
...
STDROMPICKEXT(zerofxts, zerofxts, pgm)
STD_ROM_FN(zerofxts)

struct BurnDriver BurnDrvzerofxts = {
       "zerofxts", "olds", "pgm", NULL, "2019-06-06",
       "Oriental Legend ZERO fxts (Hack)\0", NULL, "Hack", "PolyGameMaster",
       L"Oriental Legend ZERO (Hack)\0\u897f\u904a\u91cb\u5384\u50b3 ZERO (\u4fee\u6539\u7248)\0", NULL, NULL, NULL,
       BDF_GAME_WORKING | BDF_CLONE | BDF_HACK, 4, HARDWARE_IGS_PGM, GBF_SCRFIGHT, 0,
       NULL, zerofxtsRomInfo, zerofxtsRomName, NULL, NULL, NULL, NULL, pgmInputInfo, oldschsDIPInfo,
       oldsInit, pgmExit, pgmFrame, pgmDraw, pgmScan, &nPgmPalRecalc, 0x900,
       448, 224, 4, 3
};
